...
impl Cpu {
  ...
  pub fn step(&mut self) -> u8 {
    ...
    match opcode {
      ...
      0x80 => self.op_add_a_r(B),
      0x81 => self.op_add_a_r(C),
      0x82 => self.op_add_a_r(D),
      0x83 => self.op_add_a_r(E),
      0x84 => self.op_add_a_r(H),
      0x85 => self.op_add_a_r(L),
      0x86 => self.op_add_a_hl(),
      0x87 => self.op_add_a_r(A),

      0x88 => self.op_adc_a_r(B),
      0x89 => self.op_adc_a_r(C),
      0x8A => self.op_adc_a_r(D),
      0x8B => self.op_adc_a_r(E),
      0x8C => self.op_adc_a_r(H),
      0x8D => self.op_adc_a_r(L),
      0x8E => self.op_adc_a_hl(),
      0x8F => self.op_adc_a_r(A),
